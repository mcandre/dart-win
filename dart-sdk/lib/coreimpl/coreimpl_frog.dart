...
#source("frog/dual_pivot_quicksort.dart");
#source("frog/duration_implementation.dart");
#source("frog/exceptions.dart");
#source("frog/future_implementation.dart");
#source("frog/hash_map_set.dart");
// TODO(jimhug): Re-explore tradeoffs with using builtin JS maps.
#source("frog/linked_hash_map.dart");
#source("frog/maps.dart");
#source("frog/options.dart");
#source("frog/promise_implementation.dart");
#source("frog/queue.dart");
#source("frog/stopwatch_implementation.dart");
#source("frog/splay_tree.dart");

#source("frog/string_buffer.dart");
#source("frog/string_base.dart");
#source("frog/string_implementation.dart");
#source("frog/arrays.dart");
#source("frog/collections.dart");
#source("frog/date_implementation.dart");

#source("frog/isolate.dart");
#source("frog/isolate_serialization.dart");

#source("frog/function_implementation.dart");
